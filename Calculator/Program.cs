...
namespace Scientific_Calculator
{
    ...
    {
        static string staticVar = "DEG";
        static string staticVar1 = "f-e";
        static string staticVar2 = "";

        public static void Main()
        {
            Console.WriteLine();
            Console.WriteLine($"{staticVar}  {staticVar1}  {staticVar2}");
            ...
            do
            {
                ...
                else if (IsValidInputKey(keyInfo.KeyChar))
                {
                    ...
                    else if (inputChar == '=' && extOp)
                    {
                        ...
                        if (calculate.Length >= 1 && IsOperatorKey(calculate[calculate.Length - 1]))       
                        {
                            currentNumber = ArithmeticOperations.Evaluate(calculate.ToString(), staticVar1);
                        }
                    ...
                    else if (inputChar == '=' && !extOp)
                    {
                        ...
                        result = ArithmeticOperations.Evaluate(calculate.ToString(), staticVar1);
                        restart = true;
                        calculate.Clear();
                        calculate.Append(result);
                        number.Clear();
            ...
            void IsTrigonometricFunctionKey(char c)
            {
                ...
                switch (c)
                {
                    case 's':
                        ...
                        currentNumber = PowerOperations.Sine(CalculateTrigonometricValue(result, staticVar));
                        break;
                    ...
                    case 'c':
                        ...
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.Cosine(CalculateTrigonometricValue(result, staticVar));
                        break;
                    case 't':
                        ClearConsoleExceptFirstTwoLine();
                        number.Insert(0, "tan(").Append(")");
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.Tangent(CalculateTrigonometricValue(result, staticVar));
                        break;
                    case 'S':
                        ...
                        else
                        {
                            ...
                            number.Insert(0, "Sin^(-1)(").Append(")");
                            Console.Write(s.ToString() + number.ToString());
                            currentNumber = PowerOperations.SineInverse(result, staticVar);
                        }
                        break;
                    ...
                    case 'C':
                        ...
                        else
                        {
                            ...
                            number.Insert(0, "cos^(-1)(").Append(")");
                            Console.Write(s.ToString() + number.ToString());
                            currentNumber = PowerOperations.CosineInverse(result, staticVar);
                        }
                    ...
                    case 'T':
                        ...
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.TangentInverse(result, staticVar);
                        break;
                    case 'g':
                        ClearConsoleExceptFirstTwoLine();
                        number.Insert(0, "Cosec(").Append(")");
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.Cosec(CalculateTrigonometricValue(result, staticVar));
                        break;
                    case 'G':
                        if (result > -1 && result < 1)
                        {
                        ...
                        number.Insert(0, "Cosec^(-1)(").Append(")");
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.CosecInverse(result, staticVar);
                        break;
                    case 'h':
                        ClearConsoleExceptFirstTwoLine();
                        number.Insert(0, "Sec(").Append(")");
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.Sec(CalculateTrigonometricValue(result, staticVar));
                        break;
                    case 'H':
                        if (result > -1 && result < 1)
                        {
                        ...
                        else
                        {
                            ...
                            number.Insert(0, "Sec^(-1)(").Append(")");
                            Console.Write(s.ToString() + number.ToString());
                            currentNumber = PowerOperations.SecInverse(result, staticVar);
                        }
                    ...
                    case 'k':
                        ...
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.Cot(CalculateTrigonometricValue(result, staticVar));
                        break;
                    case 'K':
                        ClearConsoleExceptFirstTwoLine();
                        number.Insert(0, "Cot^(-1)(").Append(")");
                        Console.Write(s.ToString() + number.ToString());
                        currentNumber = PowerOperations.CotInverse(result, staticVar);
                        break;
                    case 'l':
                        ClearConsoleExceptFirstTwoLine();
        ...
        public static void ClearStatusLine(String status)
        {
            ...
            Console.Write($"{staticVar} | {staticVar1} | {staticVar2}");
        ...
        static double CalculateTrigonometricValue(double angle, string inputUnit)
        {
            ...
            switch (inputUnit)
            {
                ...
                case "GRAD":
                    ...
                    break;
                default:
                    throw new ArgumentException("Invalid unit. Enter units are 'RAD', 'DEG', and 'GRAD'.");
            }
            return angleRad;
